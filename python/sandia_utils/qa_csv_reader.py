...
class qa_csv_reader (gr_unittest.TestCase):
    ...
    def test_001_all_header_fields(self):
        ...
        # start reader/
        reader = sandia_utils.csv_reader(fname='/tmp/file.csv', has_header=True,
    ...
    def test_002_no_header(self):
        ...
        # start reader/
        reader = sandia_utils.csv_reader(fname='/tmp/file.csv', has_header=False,
                                         period=10, start_delay=0, repeat=False)
    ...
    def test_003_data_types(self):
        ...
        for data_type, init_func in data_types.items():
            # start reader/
            reader = sandia_utils.csv_reader(fname='/tmp/file.csv', data_type=data_type,
    ...
    def test_004_key_list_header_fields(self):
        with open('/tmp/file.csv', 'w') as f:
            # write header
            f.write('field0(string), , field1(bool), field2(float),' +
                    'field3(long), field4(uint64), field5(double),' +
        ...
        # start reader/
        reader = sandia_utils.csv_reader(fname='/tmp/file.csv', has_header=True,
                                         period=10, start_delay=0, repeat=False, key_list=['field0', 'field1', 'field5', 'field7'])
    ...
    def test_005_key_list_partial_missing_fields(self):
        with open('/tmp/file.csv', 'w') as f:
            # write header
            f.write('field0(string), , field1(bool), field2(float),' +
                    'field3(long), field4(uint64), field5(double),' +
        ...
        # start reader/
        reader = sandia_utils.csv_reader(fname='/tmp/file.csv', has_header=True,
                                         period=10, start_delay=0, repeat=False, key_list=['field0', 'field1', 'field5', 'field7', 'fieldZ'])
