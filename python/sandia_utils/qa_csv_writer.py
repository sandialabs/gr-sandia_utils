...
class qa_csv_writer (gr_unittest.TestCase):
    ...
    def check_file(self, fname, expected, has_header=False, data_type='uint8'):
        ...
        reader = sandia_utils.csv_reader(fname=fname, has_header=has_header,
    ...
    def test_001_uint8_no_header(self):
        ...
        writer = sandia_utils.csv_writer('/tmp/file.csv', False, '', 'uint8')
    ...
    def test_002_uint8_metadata_header(self):
        emitter = pdu_utils.message_emitter()
        writer = sandia_utils.csv_writer('/tmp/file.csv', True, '', 'uint8')
    ...
    def test_003_uint8_formatted_header(self):
        emitter = pdu_utils.message_emitter()
        writer = sandia_utils.csv_writer('/tmp/file.csv', True, 'a(string),b(long)', 'uint8')
    ...
    def test_004_all_data_types(self):
        ...
        for data_type, init_func in data_types.items():
            emitter = pdu_utils.message_emitter()
            writer = sandia_utils.csv_writer('/tmp/file.csv', False, '', data_type)
    ...
    def test_005_all_header_fields(self):
        ...
        writer = sandia_utils.csv_writer('/tmp/file.csv', True, fields, 'uint8')
    ...
    def test_006_precision(self):
        emitter = pdu_utils.message_emitter()
        writer = sandia_utils.csv_writer('/tmp/file.csv', False, '', 'float', precision=4)
    ...
    def test_007_time(self):
        emitter = pdu_utils.message_emitter()
        writer = sandia_utils.csv_writer('/tmp/file.csv', True, 'time(time)', 'uint8', precision=4)
    ...
    def test_008_time_tuple(self):
        emitter = pdu_utils.message_emitter()
        writer = sandia_utils.csv_writer('/tmp/file.csv', True, 'time(time_tuple)', 'uint8', precision=4)
    ...
    def test_009_float_precision(self):
        ...
        writer = sandia_utils.csv_writer('/tmp/file.csv', True, fields, 'uint8', precision=4)
