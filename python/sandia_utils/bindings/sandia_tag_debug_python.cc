...
/* BINDTOOL_HEADER_FILE_HASH(85361aa89c36b8390bd8877b1da0578f)                     */
/***********************************************************************************/
...
void bind_sandia_tag_debug(py::module& m)
{
    ...
    py::class_<sandia_tag_debug,
               ...
               gr::block,
               gr::basic_block,
               std::shared_ptr<sandia_tag_debug>>(
        m, "sandia_tag_debug", D(sandia_tag_debug))
        ...
        .def("current_tags",
             &sandia_tag_debug::current_tags,
             D(sandia_tag_debug, current_tags))


        .def("get_tag",
             &sandia_tag_debug::get_tag,
             py::arg("idx"),
        ...
        .def("set_display",
             &sandia_tag_debug::set_display,
             py::arg("d"),
             D(sandia_tag_debug, set_display))


        .def("set_key_filter",
             &sandia_tag_debug::set_key_filter,
             py::arg("key_filter"),
