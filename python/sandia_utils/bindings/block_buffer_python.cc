...
/* BINDTOOL_HEADER_FILE_HASH(afb6f59a47bc39c354c272cda9c04e40)                     */
/***********************************************************************************/
...
void bind_block_buffer(py::module& m)
{
    ...
    py::class_<block_buffer, gr::block, gr::basic_block, std::shared_ptr<block_buffer>>(
        m, "block_buffer", D(block_buffer))
        ...
        .def("set_nsamples",
             &block_buffer::set_nsamples,
             py::arg("nsamples"),
             D(block_buffer, set_nsamples))


        .def("set_pass_data",
             &block_buffer::set_pass_data,
             py::arg("pass_data"),
             D(block_buffer, set_pass_data))


        .def(
            "get_pass_data", &block_buffer::get_pass_data, D(block_buffer, get_pass_data))
